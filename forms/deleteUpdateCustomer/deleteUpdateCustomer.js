...
let query = "SELECT name FROM customer;" 
  req1 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=pgu04554&pass=Priyanka98*&database=pgu04554&query=" + query)
 ...
 check = company
  ...
  req1 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=pgu04554&pass=Priyanka98*&database=pgu04554&query=" + query1)
    ...
    if (results.length == 0)
            ...
            req3 = AjaxAjax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=pgu04554&pass=Priyanka98*&database=pgu04554&query=" + query2)
            query3 = "SELECT DISTINCT name FROM customer;" 
            req4 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=pgu04554&pass=Priyanka98*&database=pgu04554&query=" + query3)
